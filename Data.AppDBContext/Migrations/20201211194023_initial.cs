    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerformerAlbums", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PerformerAlbums_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PerformerAlbums_Performers_PerformerId",
                        column: x => x.PerformerId,
                        principalTable: "Performers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformerAlbums_AlbumId",
                table: "PerformerAlbums",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_PerformerAlbums_PerformerId",
                table: "PerformerAlbums",
                column: "PerformerId");
